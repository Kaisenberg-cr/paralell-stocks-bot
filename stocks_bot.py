...
class StocksBot:
    ...
    def collect_and_write_data(self, ticker, char):
        ...
        return_on_equity = self.pyppeteer_extensions.get_text(
            '(//div[text()="Return On Equity"]/parent::div/parent::div/parent::div/parent::div/div)[12]/div/div/div'
        )
        time.sleep(1)
        asset_turnover = self.pyppeteer_extensions.get_text(
            '(//div[text()="Asset Turnover"]/parent::div/parent::div/parent::div/parent::div/div)[12]/div/div/div'
        )
        time.sleep(1)
